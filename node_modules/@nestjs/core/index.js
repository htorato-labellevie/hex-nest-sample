"use strict";
/* build-hook-start *//*00001*/try { require('/Users/htorato/.vscode/extensions/wallabyjs.console-ninja-1.0.426/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '206aafa94cc11371d98520HE9LSEsDA1JUUAACUlNcXFxTAgcA', mode: 'runtime'}); } catch(cjsError) { try { import('file:///Users/htorato/.vscode/extensions/wallabyjs.console-ninja-1.0.426/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '206aafa94cc11371d98520HE9LSEsDA1JUUAACUlNcXFxTAgcA', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
